...
class WordRepository(BaseRepository[Word]):
    ...
    def get_words_without_audio(self, db: Session, course_id: Optional[int] = None) -> List[Word]:
    ...
    def get_word_statistics(self, db: Session, course_id: Optional[int] = None) -> dict:
    ...
    def find_similar_words(
        ...
        # Simple similarity using partial matching
    ...
    def get_words_for_review(
        ...
        """Get words suitable for review based on user's learning progress"""
        # This would typically integrate with progress tracking
